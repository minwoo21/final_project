...
(
    ...
    `MEMBER_NUM`    VARCHAR(45)    NOT NULL    COMMENT '제출자',
    `DATE`   VARCHAR(45)    NOT NULL    COMMENT '시간',
    `CONTENT`   VARCHAR(2000)    NOT NULL    COMMENT '내용',
    PRIMARY KEY (NUM)
);
...
(
    'NUM' INTEGER NOT NULL AUTO_INCREMENT COMMENT '수업 번호'
    'MEMBER_ID' INTEGER NOT NULL '회원 정보'
    'LESSON_NUM' INTEGER NOT NULL COMMENT '수업 번호'
    'LSEEON_NAME' VARCHAR(45) NOT NULL COMMENT '수업이름'
    'LESSON_PRO' VARCHAR(45) NOT NULL COMMENT '강사 이름'
    PRIMARY KEY(NUM)
)